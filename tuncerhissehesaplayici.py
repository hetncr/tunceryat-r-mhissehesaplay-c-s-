...
if hisse_adi:
  ...
  st.write(" Tradingview Grafik Sayfası İçin Tıklayın: [link](https://tr.tradingview.com/symbols/BIST-"hisse_input")   #(https://tr.tradingview.com/chart/)")
...
# Özsermaye
  ...
  if stock_name in hisse_oran:
      try:
          ...
          kapanıs = hisse_oran[stock_name]["kapanıs"].replace(",",".")  # Extract kapanıs 
